 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Mail\Mailer         
                        /** @var \BeyondCode\HeloLaravel\Laravel7Mailer $instance */
                        return $instance->html($html, $callback);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Mail\Mailer         
                        /** @var \BeyondCode\HeloLaravel\Laravel7Mailer $instance */
                        return $instance->plain($view, $data, $callback);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getSymfonyTransport()
        {            //Method inherited from \Illuminate\Mail\Mailer         
                        /** @var \BeyondCode\HeloLaravel\Laravel7Mailer $instance */
                        return $instance->getSymfonyTransport();
        }
                    /**
         ...
         * @static 
         */ 
        public static function setSymfonyTransport($transport)
        {            //Method inherited from \Illuminate\Mail\Mailer         
                        /** @var \BeyondCode\HeloLaravel\Laravel7Mailer $instance */
                        $instance->setSymfonyTransport($transport);
        }
                    /**
        ...
        public static function flushMacros()
        {            //Method inherited from \Illuminate\Mail\Mailer         
                        \BeyondCode\HeloLaravel\Laravel7Mailer::flushMacros();
        }
                    /**
...
')
     ...
     */ 
         ...
         * 
         *
         * @param \Rebing\GraphQL\array<string,mixed>|null $variables Optional GraphQL input variables for your query/mutation
         * @param \Rebing\GraphQL\array<string,mixed> $opts Additional options, like 'schema', 'context' or 'operationName'
         * @return \Rebing\GraphQL\array<string,mixed> 
         * @static 
         */ 
         ...
         * 
         *
         * @param \Rebing\GraphQL\array<int|\Rebing\GraphQL\string,string> $types
         * @static 
         */ 
         ...
         * 
         *
         * @param \GraphQL\Type\Definition\ObjectType|\Rebing\GraphQL\array<int|\Rebing\GraphQL\string,class-string|\Rebing\GraphQL\array<string,mixed>>|string $type
         ...
         * 
         *
         * @param \Rebing\GraphQL\array<string,mixed> $schemaConfig
         * @static 
         */ 
         ...
         * 
         *
         * @return \Rebing\GraphQL\array<Schema> 
         * @static 
         */ 
         ...
         * 
         *
         * @return \Rebing\GraphQL\array<string,array<string,mixed>> 
         * @static 
         */ 
